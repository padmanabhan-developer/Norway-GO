<div class="opret_cykel">
    ...
    document.write('<a href="' + document.referrer + '">TILBAKE</a>');
                    ...
                    <h2 id="overskjult">OPRETT <strong>SYKEL</strong></h2>
                       <h2 id="overskjult2">RETT <strong>SYKEL</strong></h2>
                     <div class="form_row">
                    	 <span class="form_box" id="hertur1">
                         	   <label>SYKEL NAVN</label>
                    ...
                    <h3>Når <strong> sykkelen ikke kan bestilles ?</strong></h3>
...
<script type="text/javascript">
    ...
    (function ($) {
     ...
     $("#edit-title").attr("placeholder", "SYKELNS NAVN");
     ...
     $("#edit-field-cykel-cykelnummer-und-0-value").attr("placeholder", "Sykelnummer");
