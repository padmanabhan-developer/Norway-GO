...
<div class="opret_tur">
                  <div class="opret_tur_left">
                        ...
                        <div class="row11">
                           ...
                           <input class="button24" type="submit" id="edit-submit4" name="op" value="OPRETT TUR" disabled>
                        </div><!--close row11-->
                ...
                <?php print $content['mc3']; ?>
                    ...
                    <?php print $content['mc7']; ?>
                        <label id="kanikkebookes">Sykkelen er inkludert i en gitt periode.</label>
...
//   $("#edit-field-tur-beboer-und").addClass('list3');
 ...
 //$("#edit-field-testlokation-und option").css("display","none");
   ...
   // $('#edit-field-testlokation-und option:first').text('Välj lokation');
     $("<option value='0' disabled>Velg sted</option>").insertBefore($('#edit-field-testlokation-und option:first'));
...
<?
   ...
   {
   ?>
    $("#edit-field-tur-kommentar-und-0-value").attr("placeholder", "GE KOMMENTARER PÅ TOUR HER");
   <?
   }
   ?>

 $('#edit-field-tur-beboer-und option:first').text('Velg passasjerer');
...
$("#edit-field-tur-dato-und-0-value-timepicker-popup-1").val("Velg tid");
$("#edit-field-tur-dato-und-0-value2-timepicker-popup-1").val("Velg tid");
