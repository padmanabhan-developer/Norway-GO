...
<div class="clear"></div>
                        <h2>OPPRETT <strong>STED</strong></h2>
...
<script type="text/javascript">
    ...
    $('#edit-field-godkendte-piloter').appendTo('#hertur1');
     ...
     $("#edit-body-und-0-value").attr("placeholder", "Praktisk info");
         ...
         $('<label>Gatenavn</label>').appendTo('#hertur1a');
$('#edit-field-lokation-vejnavn-und-0-value').appendTo('#hertur1a');
     ...
     $("#edit-field-lokation-vejnavn-und-0-value").attr("placeholder", "Gatenavn");
 ...
 $('#edit-delete').appendTo('#hertur7');
     ...
     $('<label>Google Map adresse</label>').appendTo('#herturgoogle');
     ...
     $("#edit-field-lokation-googlemaps-und-0-value").attr("placeholder", "Google Map adresse");
