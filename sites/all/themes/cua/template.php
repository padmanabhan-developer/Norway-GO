...
function cua_menu_tree__user_menu(&$variables) {
 $user_data = user_load($GLOBALS['user']->uid);
   ...
   if (in_array('frivillig', $user->roles) && $user_data->field_har_taget_introtur['und'][0][value] != 1) {
    ...
    // $output = str_replace($removeword, '', $output);
    $removeword = '<li class="leaf"><a href="/ture" title="">TURER</a></li>';
    $output = str_replace($removeword, '', $output);
    $removeword = '<li class="leaf active-trail"><a href="/ture" title="" class="active-trail active">TURER</a></li>';
    $output = str_replace($removeword, '', $output);
    ...
    $show_user_to_opt_one_location_selectedmenu = '<li class="leaf active-trail"><a href="/valg-lokationer" title="" class="active-trail active">PLATSER</a></li>';
    $show_user_to_opt_one_location = '<li class="leaf"><a href="/valg-lokationer" title="">PLATSER</a></li>';
    /*
    ...
    */
    $removeword = '<li class="leaf"><a href="/lokationer" title="">PLATSER</a></li>';
    $output = str_replace($removeword, $show_user_to_opt_one_location, $output);
    $removeword = '<li class="leaf active-trail"><a href="/lokationer" title="" class="active-trail active">PLATSER</a></li>';
