            ...
            _items: function(i, startTime) {
                ...
                while(time < end) {
                    if (widget._isValidTime(i, time)) {
                        item = $('<li id="tid' + $.fn.timepicker.formatTime(i.options.timeFormat, time).replace(':', '') + '">').addClass('ui-menu-item uimenuitem' + $.fn.timepicker.formatTime(i.options.timeFormat, time).replace(':', '')).appendTo(ul);
